...
./build/system/permissionobject.o: ./src/system/permissionobject.cpp
	g++ -I ./include ./src/system/permissionobject.cpp -o ./build/system/permissionobject.o ${OBJECT_FILE_FLAGS}
./build/system/permissionsobject.o: ./src/system/permissionsobject.cpp
	g++ -I ./include ./src/system/permissionsobject.cpp -o ./build/system/permissionsobject.o ${OBJECT_FILE_FLAGS}
./build/system/permissionnode.o: ./src/system/permissionnode.cpp
	g++ -I ./include ./src/system/permissionnode.cpp -o ./build/system/permissionnode.o ${OBJECT_FILE_FLAGS}
./build/system/permissionpropertyobject.o: ./src/system/permissionpropertyobject.cpp
	g++ -I ./include ./src/system/permissionpropertyobject.cpp -o ./build/system/permissionpropertyobject.o ${OBJECT_FILE_FLAGS}
./build/system/basesystemhandler.o: ./src/system/basesystemhandler.cpp
	g++ -I ./include ./src/system/basesystemhandler.cpp -o ./build/system/basesystemhandler.o ${OBJECT_FILE_FLAGS}
modules:
