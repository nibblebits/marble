...
./build/system/modulehandlingpermissionobject.o: ./src/system/modulehandlingpermissionobject.cpp
	g++ -I ./include ./src/system/modulehandlingpermissionobject.cpp -o ./build/system/modulehandlingpermissionobject.o ${OBJECT_FILE_FLAGS}
./build/system/nullnode.o: ./src/system/nullnode.cpp
	g++ -I ./include ./src/system/nullnode.cpp -o ./build/system/nullnode.o ${OBJECT_FILE_FLAGS}
./build/system/requirenode.o: ./src/system/requirenode.cpp
	g++ -I ./include ./src/system/requirenode.cpp -o ./build/system/requirenode.o ${OBJECT_FILE_FLAGS}
modules:
