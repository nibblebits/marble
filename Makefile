SYSTEM_OBJECT_FILES = ./build/system/token.o ./build/system/splitter.o ./build/system/interpreter.o ./build/system/lexer.o ./build/system/parser.o ./build/system/node.o ./build/system/expnode.o ./build/system/varnode.o
OBJECT_FILE_FLAGS = -c -g -fPIC -std=c++11
...
system:
	...
	g++ ${SYSTEM_OBJECT_FILES} -o ${SYSTEM_LIB_FILE_LOCATION}  -shared -Wl,-rpath,'./lib'-export-dynamic
standalone: system
	cd bin; \
	g++ -I ../include ../src/standalone/main.cpp ./${SYSTEM_LIB_LOCAL_FILENAME} -o ./marble;
clean:
