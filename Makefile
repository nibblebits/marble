...
APACHE_OBJECT_FILES = ./src/apache/build/webmod.o ./src/apache/build/responseobject.o ./src/apache/build/cookiepermission.o ./src/apache/build/headerpermission.o ./src/apache/build/requestargumentsobject.o ./src/apache/build/multipartfileobject.o
