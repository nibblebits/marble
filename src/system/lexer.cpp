...
#include "statics.h"
#include "config.h"
const char keywords[][MAX_KEYWORD_SIZE] = {"public", "private", "protected", "function", "number", "byte", "string", "bool", "int", "class", "return", "continue", "break", "void", "new", "if", "else", "extends", "throw", "try", "catch", "do", "while", "break", "continue", "for", "include", "include_once", "pure"};
