...
Value OutputNode::interpret(Interpreter* interpreter, struct extras extra)
{
    ...
    {
        throw SystemException(std::dynamic_pointer_cast<ExceptionObject>(Object::create(interpreter, interpreter->getClassSystem()->getClassByName("InvalidTypeException"), {})), "Direct output is only allowed for strings. You should cast this");
    }
